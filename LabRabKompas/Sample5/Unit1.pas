...
uses
  ...
  Dialogs, SldWorks_TLB, StdCtrls, CommonModelingUnit;
...
var SW: ISldWorks;
   ...
   hr:HRESULT;
   x0,y0,B,L0,A,bH,c,dw4,dw1,dw2,b6,dw3,ba,G: Extended;
...
(MD2 as IModelDoc2).AddHorizontalDimension(x0+B/2, y0+L0+0.005, 0);
 ...
 Seg[26]:= md2.ICreateLine2(x0+A, y0+((L0-dw4)/2), 0, x0+A,(y0+((L0-dw4)/2))+dw4, 0) ;   //A
 md2.SketchAddConstraints ('sgVERTICAL');
 Seg[27]:= md2.ICreateLine2(x0+A, (y0+((L0-dw4)/2))+dw4, 0, x0+A+bH, (y0+((L0-dw4)/2))+dw4, 0) ;   //bH
 md2.SketchAddConstraints ('sgHORIZONTAL');
 (MD2 as IModelDoc2).AddHorizontalDimension(x0+B/2, y0-0.005, 0);
 Seg[28]:= md2.ICreateLine2(x0+A+bH, (y0+((L0-dw4)/2))+dw4, 0, x0+A+bH, y0+((L0-dw4)/2), 0) ;
 md2.SketchAddConstraints ('sgVERTICAL');
 Seg[29]:= md2.ICreateLine2(x0+A+bH, y0+((L0-dw4)/2), 0, x0+A, y0+((L0-dw4)/2), 0) ;
 md2.SketchAddConstraints ('sgHORIZONTAL');


 Seg[30]:= md2.ICreateLine2(x0+A+bH, y0+(L0-dw4)/2+5/6*dw4, 0, x0+A+bH+c, y0+(L0-dw4)/2+5/6*dw4, 0) ;
 (MD2 as IModelDoc2).AddHorizontalDimension(x0+B/2, y0+L0+0.005, 0);
 Seg[31]:= md2.ICreateLine2(x0+A+bH, y0+(L0-dw4)/2+1/3*(dw4/2), 0,  x0+A+bH+c, y0+(L0-dw4)/2+1/3*(dw4/2), 0) ;  //c
 md2.SketchAddConstraints ('sgHORIZONTAL');
 ...
 Seg[35]:= md2.ICreateLine2(x0+A+bH+c+b6, y0+(L0-dw4)/2+5/6*dw4, 0,x0+A+bH+2*c+b6, y0+(L0-dw4)/2+5/6*dw4, 0) ;
(MD2 as IModelDoc2).AddHorizontalDimension(x0+B/2, y0+L0+0.005, 0);
 Seg[36]:= md2.ICreateLine2(x0+A+bH+c+b6, y0+(L0-dw4)/2+1/3*(dw4/2), 0,  x0+A+bH+2*c+b6, y0+(L0-dw4)/2+1/3*(dw4/2), 0) ;  //c
 md2.SketchAddConstraints ('sgHORIZONTAL');
 ...
 Seg[41]:= md2.ICreateLine2(x0+A+bH+2*c+b6, y0+A+(dw2-dw3)/2+dw3, 0, x0+A+bH+2*c+b6, y0+A+(dw2-dw3)+dw3+dw1, 0) ;
 md2.SketchAddConstraints ('sgVERTICAL');
 Seg[41].Set_Style(5);
 Seg[42]:= md2.ICreateLine2(x0+A+bH+2*c+b6, y0+A+(dw2-dw3)+dw3+dw1, 0, x0+A+bH+2*c+b6, y0+A+dw2+dw1+dw3, 0) ;
 Seg[43]:= md2.ICreateLine2(x0+A+bH+2*c+b6, y0+A+dw2+dw1+dw3, 0, x0+A+bH+2*c+b6+ba, y0+A+dw2+dw1+dw3, 0) ;
 Seg[44]:= md2.ICreateLine2(x0+A+bH+2*c+b6+ba, y0+A+dw2+dw1+dw3, 0, x0+A+bH+2*c+b6+ba, y0+A+(dw2-dw3)+dw3+dw1, 0) ;
 Seg[45]:= md2.ICreateLine2(x0+A+bH+2*c+b6+ba, y0+A+(dw2-dw3)+dw3+dw1, 0, x0+A+bH+2*c+b6, y0+A+(dw2-dw3)+dw3+dw1, 0) ;
 Seg[46]:= md2.ICreateLine2(x0+A+bH+2*c+b6+ba, y0+A+(dw2-dw3)+dw3+dw1, 0, x0+A+bH+2*c+b6+ba, y0+A+(dw2-dw3)/2+dw3, 0) ;
 Seg[46].Set_Style(5);

 Seg[47]:= md2.ICreateLine2(x0+A+bH+2*c+b6+ba, y0+A+(dw2/2), 0, x0+A+bH+3*c+b6+ba, y0+A+(dw2/2), 0) ;
 (MD2 as IModelDoc2).AddHorizontalDimension(x0+B/2, y0-0.005, 0);                                                 //c
 Seg[48]:= md2.ICreateLine2(x0+A+bH+2*c+b6+ba, y0+(L0-dw4)/2+5/6*dw4, 0, x0+A+bH+3*c+b6+ba, y0+(L0-dw4)/2+5/6*dw4, 0) ;
 ...
 Seg[53]:= md2.ICreateLine2(x0+A+bH+3*c+b6+ba, y0+A+(dw2/2), 0, x0+2*A+2*bH+3*c+b6+ba,y0+A+(dw2/2), 0) ;
 Seg[54]:= md2.ICreateLine2(x0+A+bH+3*c+b6+ba,  y0+(L0-dw4)/2+5/6*dw4, 0, x0+2*A+2*bH+3*c+b6+ba, y0+(L0-dw4)/2+5/6*dw4, 0) ;
 ...
 Seg[60]:= md2.ICreateLine2(x0+A+bH+c,  y0+A+dw2, 0, x0+A+bH+c+b6,  y0+A+dw2, 0) ;
 Seg[61]:= md2.ICreateLine2(x0+A+bH+c,  y0+A+2*dw2, 0, x0+A+bH+c+b6,  y0+A+2*dw2, 0) ;
...
(md2 as IModelDoc2).AddDiameterDimension2(x0+B+G+L0/2+0.03, y0+L0/2+0.06, 0);
 ...
 Seg[79]:= md2.ICreateLine2(x0+B+0.05,  y0, 0, x0+B+G+L0/2,  y0, 0) ;
 Seg[80]:= md2.ICreateLine2(x0+B+0.05,  y0+L0, 0, x0+B+G+L0/2,  y0+L0, 0) ;
 Seg[81]:= md2.ICreateLine2(x0+B+0.05,  y0, 0, x0+B+0.05,  y0+L0, 0) ;

 Poi[0] := md2.ICreatePoint2(x0+B+G+L0, y0+L0/2, 0);
 Poi[1] := md2.ICreatePoint2(x0+B+G+A, y0+L0/2, 0);
end;
