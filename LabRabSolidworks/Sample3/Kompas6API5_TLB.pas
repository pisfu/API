...
// ************************************************************************  //
// Type Lib: C:\Program Files\ASCON\KOMPAS-3D V10\Bin\kAPI5.TLB (1)
...
// *********************************************************************//
  ksDocument2D = dispinterface
    ...
    function ksSetMacroWaitDblClickEdit(ref: Integer): Integer; dispid 214;
    ...
    function ksGetShelfPoint(p: Integer; index: Integer; var x: Double; var y: Double; 
                             paramType: Integer): Integer; dispid 230;
...
// *********************************************************************//
  ksDocument3D = dispinterface
    ...
    function Create(Visible: WordBool; typeDoc: WordBool): WordBool; dispid 5;
...
// *********************************************************************//
  ksEntity = dispinterface
    ...
    function GetAdvancedColor(var GetAdvancedColor: Integer; var ambient: Double; 
                              var diffuse: Double; var specularity: Double; var shininess: Double; 
...
// *********************************************************************//
  ksNurbs3dParam = dispinterface
    ...
    function GetNurbsPoints3DParams(unClamped: WordBool; var points: OleVariant; 
